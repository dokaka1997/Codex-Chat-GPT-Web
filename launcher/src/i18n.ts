...
const zh: Record<keyof typeof en, string> = {
  ...
  continue: "继续",
  supportTitle: "开始之前",
  supportBody: "请为仓库 Star，并打开我的 Facebook 主页，帮助更多开发者发现 Codex Web GPT。",
  star: "在 GitHub 上 Star",
  starred: "已打开 GitHub",
  follow: "打开我的 Facebook",
  followed: "已打开 Facebook",
  finishWelcome: "打开启动器",
  setup: "设置",
  activity: "活动",
  settings: "设置项",
...
const ja: Record<keyof typeof en, string> = {
  ...
  continue: "続ける",
  supportTitle: "開始する前に",
  supportBody: "より多くの開発者に Codex Web GPT を知ってもらうため、リポジトリに Star を付け、私の Facebook プロフィールを開いてください。",
  star: "GitHub で Star",
  starred: "GitHub を開きました",
  follow: "Facebook を開く",
  followed: "Facebook を開きました",
...
const ko: Record<keyof typeof en, string> = {
  ...
  supportBody: "더 많은 개발자가 Codex Web GPT를 찾을 수 있도록 저장소에 Star를 누르고 제 Facebook 프로필을 열어주세요.",
  star: "GitHub에서 Star",
  starred: "GitHub 열림",
  follow: "Facebook 열기",
  followed: "Facebook 열림",
  finishWelcome: "런처 열기",
  setup: "초기 설정",
  activity: "활동",
  settings: "설정",
...
const zhTW: Record<keyof typeof en, string> = {
  ...
  continue: "繼續",
  supportTitle: "開始之前",
  supportBody: "請為儲存庫按 Star，並開啟我的 Facebook 主頁，幫助更多開發者發現 Codex Web GPT。",
  star: "在 GitHub 上按 Star",
  starred: "已開啟 GitHub",
  follow: "開啟我的 Facebook",
  followed: "已開啟 Facebook",
  finishWelcome: "開啟啟動器",
  setup: "設定",
  activity: "活動",
  settings: "設定項目",
